// add by huabo KYEEAPPC-4436 医院介绍页面controller
new KyeeModule()
    .group("kyee.quyiyuan.hospital.hospital_introduce.controller")
    .require(["kyee.framework.filter.common"
        ,"kyee.quyiyuan.hospital.hospitalWeb.controller"])
    .type("controller")
    .name("HospitalIntroduceController")
