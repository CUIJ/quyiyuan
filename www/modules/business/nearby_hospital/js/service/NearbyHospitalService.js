        ...
        var def = {
            ...
            dealData: function (data) {
                ...
                for (var i=0; i < data.RECOMMEND.length; i++) {
                    if(data.RECOMMEND[i].DEPT_NAME && data.RECOMMEND[i].DEPT_NAME.length>35){
                        data.RECOMMEND[i].DEPT_NAME = data.RECOMMEND[i].DEPT_NAME.substr(0, 35) + '...';
                    }
                }
            }
